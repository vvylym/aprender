...
fn main() {
    ...
    let x = Matrix::from_vec(15, 4, vec![
        ...
        4.6, 3.1, 1.5, 0.2,
        5.0, 3.6, 1.4, 0.2,
        // Versicolor-like (cluster 1)
        7.0, 3.2, 4.7, 1.4,
        6.4, 3.2, 4.5, 1.5,
        6.9, 3.1, 4.9, 1.5,
        5.5, 2.3, 4.0, 1.3,
        6.5, 2.8, 4.6, 1.5,
        // Virginica-like (cluster 2)
        6.3, 3.3, 6.0, 2.5,
        5.8, 2.7, 5.1, 1.9,
        7.1, 3.0, 5.9, 2.1,
        6.3, 2.9, 5.6, 1.8,
    ...
    for i in 0..15 {
        println!("{:>6} {:>10} {:>12}", i, true_labels[i], predicted_labels[i]);
    }
