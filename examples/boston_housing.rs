...
fn main() {
    ...
    let x = Matrix::from_vec(
        ...
        4,
        vec![
            1500.0, 3.0, 2.0, 10.0, 2000.0, 4.0, 2.5, 5.0, 1200.0, 2.0, 1.0, 30.0, 1800.0, 3.0,
            2.0, 15.0, 2500.0, 5.0, 3.0, 2.0, 1000.0, 2.0, 1.0, 50.0, 2200.0, 4.0, 3.0, 8.0,
    ...
    let y = Vector::from_slice(&[
        250.0, 350.0, 180.0, 280.0, 450.0, 150.0, 380.0, 260.0, 520.0, 220.0,
    ]);
