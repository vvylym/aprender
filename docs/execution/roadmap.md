...
| ID | Description | Status | Complexity | Priority |
|----|-------------|--------|------------|----------|
| GH-253-1 | Export complete tokenizer metadata (token_type, eos/bos/pad IDs, chat_template) | 🔴 todo | M | P0 |
| GH-253-2 | Fix vocab count mismatch (151665 vs 152064) in exported GGUF | 🔴 todo | S | P0 |
| GH-253-3 | Fix tokenizer.ggml.model: "bpe" → "gpt2" for byte-level BPE | 🔴 todo | S | P0 |
| GH-253-4 | Implement ValidatedGgufMetadata newtype (compile-time enforcement) | 🔴 todo | L | P0 |
| GH-253-5 | Verify exported 7B GGUF produces correct decode on CPU and GPU | 🔴 todo | M | P0 |
| GH-253-6 | Falsify F-CONTRACT-008 and F-CONTRACT-009 gates in showcase spec | 🔴 todo | S | P1 |
